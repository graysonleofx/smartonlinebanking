...
const Referral = () => {
  ...
  const shareViaEmail = () => {
    const subject = 'Join Smart Bank and earn ₦5,000!';
    const body = `Hi!

I'm inviting you to join Smart Bank - Nigeria's smartest digital banking platform.
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white space-y-8">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto leading-relaxed">
            Share Smart Bank with your friends and family. For every successful referral, 
